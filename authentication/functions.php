...
if(!mysqli_stmt_prepare($stmt, $sql)){
    header("location: http://localhost/authentication/index2.php?error=stmtfailed");
    exit();
}
...
function createUser($conn, $username, $email, $password){
    ...
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("location: http://localhost/authentication/index2.php?error=none");
    exit();
    ...
    function loginUser($conn, $username, $password){
        ...
        if($uidExists===false){
            header("location: http://localhost/authentication/index2.php?error=wronglogin");
            exit();
        }
